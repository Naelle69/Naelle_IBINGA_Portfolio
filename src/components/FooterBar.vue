<template>
  ...
  <!-- Social media -->
    ...
    <!-- Copyright -->
      <div class="bg-neutral-200 gap-2 p-6 text-center dark:bg-neutral-700 flex justify-center items-center">
...
<style>
 /*  footer{
  ...
  .color-bg{
    background: rgba(181, 129, 68, 0.83);
